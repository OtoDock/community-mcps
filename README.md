...
| [google-workspace](./workspace-mcp/) | python | [taylorwilsdon](https://github.com/taylorwilsdon/google_workspace_mcp) | `workspace-mcp` | Gmail, Drive, Calendar, Docs, Sheets, Slides, Forms, Google Tasks, Contacts, Chat, Apps Script via OAuth |
