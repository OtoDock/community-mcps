...
| Upstream project | [taylorwilsdon](https://github.com/taylorwilsdon/google_workspace_mcp) |
| Icon | none: Google's brand resource center asks third parties to request permission before using product icons |
