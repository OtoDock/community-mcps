...
- To show screenshots to the user, call `display_image` with the `/screenshots/<filename>` path returned by the Playwright tool — the display MCP auto-resolves it to the correct host location.
